...
<head>
	...
	<link rel="stylesheet" href="<?php echo base_url();?>application/views/back_end/css/screen.css" type="text/css" media="screen" title="no title" charset="utf-8" />	
	<link rel="stylesheet" href="<?php echo base_url();?>application/views/back_end/css/plugin.css" type="text/css" media="screen" title="no title" charset="utf-8" />	
	<link rel="stylesheet" href="<?php echo base_url();?>application/views/back_end/css/custom.css" type="text/css" media="screen" title="no title" charset="utf-8" />
		...
		<form action="index2.html" name="login" id="login_form" method="post">
		        ...
		        <div class="pad">
		        	...
		        	<div class="field">
						...
						<div class=""><span class="input"><input name="email" id="login_email" class="text" type="text" value="admin" /></span></div>
					</div> <!-- .field -->
