<div class="order-new clb" id="enter_names">
	...
	<h3 class="title">Enter Name: (<?php echo $description;?>)</h3>
	<div id="input_boxes">
		<div class="order-box clb input_box" value="1">
			...
			<div style="padding-left:15px;">
				...
				<label>
					...
					<input type="text" class="license license-optical" value="" name="license_1" style="width:150px">				
				</label>
				<div class="mag-pin">
				...
				<div class="order-yesno fll">
					...
					<label class="lblRadioCheckbox order-box-ss">
						<input type="radio" value="No" name="speaks_spanish_1" checked="checked" class="speaks_spanish_no">No
					</label>
					<span style="width:auto;" class="split"></span>
					<label class="lblRadioCheckbox order-box-ss">
						<input type="radio" value="Yes" name="speaks_spanish_1" class="speaks_spanish_yes">Yes
					</label>
