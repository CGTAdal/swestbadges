<form action="" method="post" id="login-form">
	<div class="login">
		...
		<div class="login-c">
			<label>
				<span style="width:210px">Market Number:</span>
				<input type="text" name="mk_number" value="<?php echo isset($mk_number)?$mk_number:"";?>" style="width:150px" id="mk_number" />
			</label>
			<label>
